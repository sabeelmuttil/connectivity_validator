...
void main() {
  final ConnectivityValidatorPlatform initialPlatform = ConnectivityValidatorPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockConnectivityValidatorPlatform fakePlatform = MockConnectivityValidatorPlatform();
    ConnectivityValidatorPlatform.instance = fakePlatform;

    expect(await connectivityValidatorPlugin.getPlatformVersion(), '42');
  });
}
